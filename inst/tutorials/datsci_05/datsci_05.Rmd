...
Welcome to the *Data Science: Productivity Tools* (`datsci_05`) module. It is designed to teach you the basics of analyzing, visualizing, and working with data using `r rproj()`.

This is the **fifth** (`datsci_05`) in a series of courses in the Introduction to Data Science program, a series of courses that prepare you to do data analysis in `r rproj()`, from simple computations to machine learning. The courses are designed to be taken in order. 
...
Finally, you will learn to write reports in RMarkdown which permits you to incorporate text and code into a document. We'll put it all together using the powerful integrated desktop environment RStudio.
